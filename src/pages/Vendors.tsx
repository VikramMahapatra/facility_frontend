...
export default function Vendors() {
  ...
  const handleSave = async (vendorData: any) => {
    ...
    if (formMode === "create") {
      ...
      if (response.success) updateVendorsPage();
    ...
    if (response.success) {
      ...
      toast.success(
        `Vendor ${vendorData.name || ""} has been ${formMode === "create" ? "created" : "updated"
        } successfully.`
      );
    }
    return response;
