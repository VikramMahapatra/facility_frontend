...
const integrationStatus = [
  { name: "Email Service", status: "connected", lastSync: "2 minutes ago", health: "excellent" },
  { name: "Weather API", status: "connected", lastSync: "15 minutes ago", health: "good" },
  { name: "Energy Monitoring", status: "connected", lastSync: "1 hour ago", health: "good" },
  { name: "SMS Service", status: "disconnected", lastSync: "Never", health: "none" },
  { name: "Accounting System", status: "error", lastSync: "3 days ago", health: "poor" },
  { name: "HRMS Integration", status: "disconnected", lastSync: "Never", health: "none" }
];
              ...
              <TabsContent value="general" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Basic system configuration and regional settings</CardDescription>
                  </CardHeader>
              ...
              <TabsContent value="integrations" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Manage external service connections and API integrations</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select 
                          ...
                          onValueChange={(value) => updateSetting("appearance", "primaryColor", value)}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">Reduce spacing and padding in the interface</p>
                        </div>
                        <Switch 
              ...
              <TabsContent value="backup" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Manage system backups and data recovery options</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-muted/50 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Automated backups are scheduled daily at 2:00 AM. Backups are stored for 30 days and then archived.
                          Critical data is backed up in real-time to ensure zero data loss.
                        </p>
                      </div>
                    </div>
                  </CardContent>
