...
export function StatsGrid() {
  ...
  const loadOverviewData = async () => {
    const overview = await withLoader(async () => {
      return await dashboardApiService.getOverview();
    });
...
export function MaintenanceOverview() {
  ...
  const loadMaintenanceData = async () => {
    const maintenanceData = await withLoader(async () => {
      return await dashboardApiService.getMaintenanceOverviewData();
    });
...
export function AccessOverview() {
  ...
  const loadAccessAndParkingData = async () => {
    const accessAndParkingData = await withLoader(async () => {
      return await dashboardApiService.getAccessAndParkingOverviewData();
    });
...
export function FinancialSummary() {
  ...
  const loadFinancialSummaryData = async () => {
    const financialSummaryData = await withLoader(async () => {
      return await dashboardApiService.getFinancialSummaryData();
    });
...
export function EnergyOverview() {
  ...
  const loadEnergyData = async () => {
    const energyData = await withLoader(async () => {
      return await dashboardApiService.getEnergyStatus();
    });
