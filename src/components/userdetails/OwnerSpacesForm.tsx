...
export default function OwnerSpacesForm({
    ...
    const ownerSpaces = watch("owner_spaces") || [];
    ...
    return (
        <>
            <div className="space-y-4">
                ...
                {/* Space Cards */}
                <div className="space-y-4">
                    {ownerSpaces.map((space: any, index: number) => (
                            ...
                            <CardContent>
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <Controller
                                            name={`owner_spaces.${index}.site_id` as any}
                                            control={control}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Controller
                                            name={
                                                `owner_spaces.${index}.building_block_id` as any
                                            }
                                            control={control}
                                            render={({ field }) => (
                                                <Select
                                    ...
                                    <div className="space-y-2">
                                        <Label>Space *</Label>
                                        <Controller
                                            name={`owner_spaces.${index}.space_id` as any}
                                            control={control}
                                            render={({ field, fieldState }) => (
                                                <>
                                                    <Select
